...
fit.coxphf = model.coxphf(MOUTH.abundance, MOUTH.event, MOUTH.meta)
```

# 4. Coxphf Permutation

```{r}
permutation.coxphf = function(Round){
    ...
    for (i in 1:Round){
        ...
        MOUTH.meta.permuted =  MOUTH.meta
        MOUTH.meta.permuted$Oral_SPF10 = sample(MOUTH.meta.permuted$Oral_SPF10, num.subject, replace = FALSE)
    
        perm.matrix[i,] = model.coxphf(MOUTH.abundance, MOUTH.event, MOUTH.meta.permuted, pl = FALSE)[,1]
    }
